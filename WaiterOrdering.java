 ...
 * @author dodom
 */
public class WaiterOrdering extends Scene{
    
    public WaiterOrdering(Parent parent, double d, double d1,Branches branch1,Tables t1,Customer c1,Manager m1,Owner owner1,Waiter waiter1,Menu menu1,Item item1,Order order1,Register Register1) {
        super(parent, d, d1);
...
Label CusID = new Label("Enter Your Customer's ID:");
TextField CustIDf = new TextField();
...
back1.setOnAction(new EventHandler<ActionEvent>() {                      
            ...
            System.out.println("Clicked");
                try {
                    ...
                    Logger.getLogger(WaiterOrdering.class.getName()).log(Level.SEVERE, null, ex);
                }
        }
        });
...
Finish.setOnAction(new EventHandler<ActionEvent>() {                      
            ...
            public void handle(ActionEvent event) {
             ...
             Alert alert1 = new Alert(Alert.AlertType.CONFIRMATION);
               ...
               str2+=order1.Ordering3waiter(order1, menu1, CustIDf.getText(),c1);
